...
const Footer: React.FC = () => {
  ...
  // Skip footer on landing page as it has its own
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <div className="flex items-center space-x-2 backdrop-panel px-3 py-1.5 rounded-sm">
              <StatusIndicator status="active" label="Network Active" />
            </div>
          </div>
          
          <div className="flex items-center space-x-4 backdrop-panel px-3 py-1.5 rounded-sm">
            {/* Twitter */}
        ...
        <div className="mt-4 text-center">
          <p className="text-white/30 text-xs">v0.1.0-alpha</p>
        </div>
      </div>
    </footer>
  );
